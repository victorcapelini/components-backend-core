...
using Xunit;
using static Optsol.Components.Test.Utils.Seed.TestEntitySeed;
...
namespace Optsol.Components.Test.Integration.Infra.Data
{
    public class RepositorySpec
    {
        ...
        public async Task Deve_Obter_Registros_Paginados()
        {
            ...
            var skip1 = requestSearchPage1.Page * (requestSearchPage1.PageSize ?? 0);
            ...
            var skip2 = requestSearchPage2.Page * (requestSearchPage2.PageSize ?? 0);
